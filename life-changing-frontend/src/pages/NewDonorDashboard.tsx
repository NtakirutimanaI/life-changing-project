  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center pt-2">
        <div>
          <h1 className="text-4xl font-extrabold text-teal-900 dark:text-white mb-2 tracking-tight">Donor Portal</h1>
          <p className="text-teal-600 dark:text-teal-400 font-medium">Thank you for your support, {currentUser.fullName}!</p>
        </div>
        <Button
