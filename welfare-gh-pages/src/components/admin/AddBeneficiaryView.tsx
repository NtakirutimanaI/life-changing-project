...
export function AddBeneficiaryView({ onCancel, onSuccess }: AddBeneficiaryViewProps) {
    ...
    return (
        <div>
            ...
            <div className="cms-card border-0 shadow-soft">
                ...
                <div className="card-body p-4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-6 mb-3">
                                <label className="small font-weight-bold text-muted">Date of Birth *</label>
                        ...
                        <div className="form-row">
                            <div className="form-group col-md-6 mb-3">
                                <label className="small font-weight-bold text-muted">Location *</label>
                            ...
                            <div className="form-group col-md-6 mb-3">
                                <label className="small font-weight-bold text-muted">Education Level</label>
                        ...
                        <h6 className="font-weight-bold text-muted mb-4 mt-4 text-uppercase small" style={{ letterSpacing: '1px' }}>Contact Information</h6>
                        <div className="form-row">
                            <div className="form-group col-md-6 mb-3">
                        ...
                        <div className="form-row">
                            <div className="form-group col-md-6 mb-3">
                                <label className="small font-weight-bold text-muted">Emergency Contact Name</label>
                            ...
                            <div className="form-group col-md-6 mb-3">
                                <label className="small font-weight-bold text-muted">Emergency Contact Phone</label>
                        ...
                        <h6 className="font-weight-bold text-muted mb-4 mt-4 text-uppercase small" style={{ letterSpacing: '1px' }}>Program Assignment</h6>
                        <div className="form-group mb-3">
                            <label className="small font-weight-bold text-muted">Assign to Program</label>
                            <select className="form-control form-control-custom"
                        ...
                        <div className="border-top pt-4 mt-4 d-flex justify-content-end">
                            ...
                            <button type="submit" className="btn btn-primary px-5 d-flex align-items-center" disabled={loading}>
                                {loading ? 'Processing...' : <><Save size={16} className="mr-1" /> Save Beneficiary</>}
                            </button>
                        </div>
                    </form>
                </div>
